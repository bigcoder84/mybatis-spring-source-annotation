...
public abstract class SqlSessionDaoSupport extends DaoSupport {
  ...
  /**
   * 用户应该使用这个方法来获取一个SqlSession来调用它的语句方法，这个SqlSession是由spring管理的。 用户不应该提交/回滚/关闭它，因为它将自动完成。 Users should use this method
   * to get a SqlSession to call its statement methods This is SqlSession is managed by spring. Users should not
